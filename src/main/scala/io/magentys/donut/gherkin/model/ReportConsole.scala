...
case class ReportConsole(allFeatures: List[Feature],
                         ...
                         allTestsTotal: Int, // Refers to all types of tests, including Scenarios, Unit tests etc.
                         allTestsPassed: Int,
                         allTestsFailed: Int,
                         totalScenarios: Int,
...
object ReportConsole {
  def apply(report: Report): ReportConsole = {
    ReportConsole(
      ...
      report.dashboardPage.reportDashboard.allTestsMetrics.total,
      report.dashboardPage.reportDashboard.allTestsMetrics.passed,
      report.dashboardPage.reportDashboard.allTestsMetrics.failed,
      ...
      report.dashboardPage.reportDashboard.scenarioMetrics.hasScenarios,
